            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地区" prop="diquValue">
                        <el-input v-model="dangaoForm.diquValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="适宜人群" prop="renqunValue">
                        <el-input v-model="dangaoForm.renqunValue"
                                  placeholder="适宜人群" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="适宜人群" prop="renqunValue">
                            <el-input v-model="ruleForm.renqunValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='dangao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="dangaoClicknum">
                        <el-input v-model="dangaoForm.dangaoClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="点击次数" prop="dangaoClicknum">
